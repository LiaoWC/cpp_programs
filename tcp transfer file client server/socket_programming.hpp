...
namespace socket_programming
{
        ...
        int bindOrConnect_socket(const char *host, const char *service, const char *transportation_type, int mode)
        {
        ...
        int bind_socket(const char *host, const char *service, const char *transportation_type)
        {
                return socket_programming::bindOrConnect_socket(host, service, transportation_type, 0);
        }

        int connect_socket(const char *host, const char *service, const char *transportation_type)
        {
                return socket_programming::bindOrConnect_socket(host, service, transportation_type, 1);
        }

        /* return how many bytes written */
        int tcp_write(int sockfd, char *cstr, int length)
        {
                int totalWritten = 0;
        ...
        int tcp_write(int sockfd, char singleChar)
        {
                char *ptr = new char [2];
                ptr[0] = singleChar;
                ptr[1] = '\0';
                int rt = socket_programming::tcp_write(sockfd,ptr,1);
                delete ptr;
                return rt;
        }

} // end of namespace socket_programming
